...
public class LowerBodyAnimation : MonoBehaviour
{
    ...
    private void OnAnimatorIK(int layerIndex)
    {
        ...
        CalcLeftFoot(hitLeftFoot, isLeftFootDown);
        CalcRightFoot(hitRightFoot, isRightFootDown);

    }

    private void CalcLeftFoot(RaycastHit hitLeftFoot, bool isLeftFootDown)
    {
        if (isLeftFootDown)
        {
    ...
    private void CalcRightFoot(RaycastHit hitRightFoot, bool isRightFootDown)
    {
        if (isRightFootDown)
        {
